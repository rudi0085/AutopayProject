<ul x-data="{open:false , open2:false, open3:false , open4:false, open5:false, open6:false}" role="list" class="divide-y divide-gray-100">
    <li class="flex justify-between gap-x-6 py-5">
      ...
      <div class="flex shrink-0 items-center gap-x-6">
        ...
        <div class="relative flex-none">
          <button @click="open = !open" @click.outside="open = false " type="button" class="-m-2.5 block p-2.5 text-gray-500 hover:text-gray-900" id="options-menu-0-button" aria-expanded="false" aria-haspopup="true">
    ...
    <li class="flex justify-between gap-x-6 py-5">
      ...
      <div class="flex shrink-0 items-center gap-x-6">
        ...
        <div class="relative flex-none">
          <button @click="open2=!open2" @click.outside="open2 = false " type="button" class="-m-2.5 block p-2.5 text-gray-500 hover:text-gray-900" id="options-menu-1-button" aria-expanded="false" aria-haspopup="true">
            <span class="sr-only">Open options</span>
            <svg class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
              <path d="M10 3a1.5 1.5 0 110 3 1.5 1.5 0 010-3zM10 8.5a1.5 1.5 0 110 3 1.5 1.5 0 010-3zM11.5 15.5a1.5 1.5 0 10-3 0 1.5 1.5 0 003 0z" />
            </svg>
    ...
    <li class="flex justify-between gap-x-6 py-5">
      ...
      <div class="flex shrink-0 items-center gap-x-6">
        ...
        <div class="relative flex-none">
          <button @click="open3=!open3" @click.outside="open3 = false "  type="button" class="-m-2.5 block p-2.5 text-gray-500 hover:text-gray-900" id="options-menu-2-button" aria-expanded="false" aria-haspopup="true">
            <span class="sr-only">Open options</span>
            <svg class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
              <path d="M10 3a1.5 1.5 0 110 3 1.5 1.5 0 010-3zM10 8.5a1.5 1.5 0 110 3 1.5 1.5 0 010-3zM11.5 15.5a1.5 1.5 0 10-3 0 1.5 1.5 0 003 0z" />
            </svg>
