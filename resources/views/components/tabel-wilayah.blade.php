...
<div class="px-4 sm:px-6 lg:px-8">
    <x-heading>Tabel Wilayah</x-heading>
            ...
            <tbody class="divide-y divide-gray-200 bg-white">
              <tr>
                ...
                <td class="relative whitespace-nowrap py-5 pl-3 pr-4 text-right text-sm font-medium sm:pr-0">
                  <a href="#" class="text-indigo-600 hover:text-indigo-900 mr-4">Edit<span class="sr-only">, Lindsay Walton</span></a>
                  <a href="#" class="text-indigo-600 hover:text-indigo-900">Hapus<span class="sr-only">, Lindsay Walton</span></a>
                </td>
              </tr>
              <tr>
                <td class="whitespace-nowrap py-5 pl-4 pr-3 text-sm sm:pl-0">
